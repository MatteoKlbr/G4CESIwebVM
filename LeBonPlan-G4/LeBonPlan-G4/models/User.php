...
class User {
    ...
    /**
 * Met à jour le profil complet d'un utilisateur (utilisé par l'administrateur).
 *
 * @param int   $userId
 * @param array $data  Associatif contenant : nom, prenom, email, role, statut_recherche, avatar, cv.
 * @return bool
