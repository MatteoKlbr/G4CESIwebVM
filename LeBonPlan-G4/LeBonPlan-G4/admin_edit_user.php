...
<body>
  ...
  <main class="container my-5">
    ...
    <form action="process/admin_edit_user_process.php" method="post" enctype="multipart/form-data">
    <!-- ID de l'utilisateur à modifier -->
      ...
      <div class="mb-3">
        ...
        <select id="role" name="role" class="form-select" required>
          ...
          <option value="pilote" <?php if($user['role'] == 'pilote') echo 'selected'; ?>>Pilote</option>
      ...
      <div class="text-center">
        ...
        <a href="admin_panel.php?section=users" class="btn btn-secondary">Annuler</a>
      </div>
    </form>
  </main>

  <footer class="text-center p-3" style="background-color:#007bff; color:white;">
    &copy;2025 - Tous droits réservés - Web4All
  </footer>
