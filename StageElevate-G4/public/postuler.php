...
<main>
  <section>
    ...
    <form action="../process/postuler_process.php" method="post" enctype="multipart/form-data" class="form-postuler">
      ...
      <br><br>
      <!-- Je viens juste d'ajouter cette partie, je veux quelle soit coherente avec le reste de la page d'une sorte que ca s'enregistre ensemble dans le database -->
      <article>
